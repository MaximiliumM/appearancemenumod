return {
	...
	},
	{
		...
		[[Complete Revamp of the Companion Equipment System]],
		[[-- Now you can select from a list of 94 weapons!]],
		[[-- You can use search to find specific weapons]],
		[[-- You can Favorite weapons]],
		[[Added Favorite button for Decor Presets]],
		[[-- This will make your favorited Presets appear at the top of the list]],
		[[Added V's AMM entities Archive XL tags file]],
		[[Removed hidden button related to a certain weapon]],
		[[Fixed issue (again) where lists would not display all items]],
		[[Fixed issue where Poses tab would not target V by default when looking at objects]],
		[[Fixed layout of ? button in Presets tab]],
	},
	{
		'2.12.2',
		'2025 Jun 10',
		[[Fixed layout issue when spawning Props]],		
	},
	{
		'2.12.1',
		'2025 Jun 10',
	...
	},
	{
		...
		[[Added template files for every Collab type in the bundle]],
		...
		[[Fixed missing localization text in various parts of the UI]],
	...
	},
	{
		...
		[[-- Thanks Cerul Liber for providing the location files!]],
		[[Added new General Target Action: All Hostile]],
		[[-- Some NPCs won't attack even as hostile]],
		[[Added new Fun Button]],
		[[Fixed Director Scripts Teams functionality]],
		[[-- Now you can assign teams to Actors again and let them fight each other]],
		[[-- They will attack teammates occasionally]],
		[[Changed Toggle Primary/Secondary Weapon buttons to Equip Primary/Secondary Weapon since toggling functionality isn't working anymore]],
		[[Removed Force Given checkbox since it was freezing the NPC in place]],
		[[-- There is no replacement for the time being]],
		[[Fixed issue where Equip Primary/Secondary Weapon buttons would not work when Companion Distance was set to Close or Nearby]],
		[[Fixed issue where Give Weapon key binding would not work]],
		[[Fixed issue where deleting a Director Script would cause internal crashes]],
		[[Fixed issue where loading a FemV save first, then loading a MaleV save (or vice versa) resulted in V being invisible when spawning]],
		[[Fixed issue where Enable Scroll Bars toggle in User Interface would not be loaded correctly from saved User settings]],
	},
	{
		'2.9.5',
		'2025 Jan 27',
	...
	},
	{
		...
		[[Added new huge Prop: Dogtown Airship]],
		[[Added requested NPCs to Swap list]],
		[[Added new Photo Mode settings tab]],
		[[Added new Reset Position for Photo Mode NPCs toggle]],
		[[-- You can turn this on, if you preferred past behavior where AMM would reset NPCs position when pressing Target buttons]],
		[[Added new Companion Resistance setting]],
		[[-- This will reduce incoming damage for your Companions]],
		[[Complete refactor of all Collab loading code]],
		[[-- This reduced AMM launch by ten times]],
		[[Rewrote Custom Appearances code to work with Photo Mode NPCs]],
		[[-- Let me know if you find Custom Appearances that aren't working]],
		[[Fixed issue where changing appearance would not work for Photo Mode NPCs if you didn't have Photo Mode NPCs Extended mod installed]],
		[[Fixed issue where AMM would display the wrong Current Appearance name for Photo Mode NPCs with Extended mod installed]],
		[[Fixed issue where Assign Seats dropdown menus would not work properly]],
		[[Fixed issue where Auto Assign Seats would not place Companions in all seats]],
	},
	{
		'2.8.8',
		'2025 Jan 20',
	...
	},
	{
		...
		[[Added Nibbles Replacer support back for users that haven't updated the game yet]],
		[[Added Crouch Indicator support to Toggle HUD hotkey]],
		[[Adjusted Director spawned Actors position to behind the Player]],
		[[Fixed issue where AMM would not load the list of appearances for certain NPCs]],
		[[Fixed issue where Target Actions would display AMM ERROR instead of the correct text]],
		[[Fixed issue where Localization was broken for Chest Stiffness and Chest Pose Override sliders]],
		[[Fixed issue where an invalid file in Locations folder could cause filtering to stop working]],
		[[Fixed issue where NPCs from Photomode NPCs Extended mod could not be moved using Tools tab]],
		[[Fixed issue where names for spawned NPCs by Photo Mode would not be displayed correctly]],
		[[Fixed issue where certain NPCs would not spawn using the new Photo Mode system]],
		[[Fixed issue where Appearances for spawned NPCs by Photo Mode would not be displayed]],
		[[-- Keep in mind that these NPCs are completely different from the ones spawned by AMM and the list of available appearances might differ]],
		[[Fixed issue where Songbird Custom Appearances would crash the game when moving far away from her]],
		[[-- Let me know if she is still crashing the game]],
	},
	{
		'2.8.1',
		'2024 Dec 29',
		[[Fixed issue where Actors would not stop the animation to move to next Mark]],
	},
	{
		'2.8',
		'2024 Dec 29',
	...
	},
	{
		...
		[[-- Orbital Air Security, Brooklyn Resident, Tactical Officer, Lucas (So Mi Ex), all Cyberjunkies and many more]],
		[[Added new Effects including:]],
		[[-- Hologram Waterfall, Hologram Big Nibbles, Hologram Dinosaurs and more]],
		[[Added new Props Category: Fake NPCs]],
		[[-- These are not actual NPCs and cannot be swapped or made followers]],
		[[-- Treat them as objects]],
		[[Added new Vehicle: Centurion 1000 6WD]],
		[[Added new default Locations including:]],
		[[-- Cynosure Core, So Mi's Apartment, Black Sapphire Stage and more]],
		[[-- Please beware of spoilers when traveling to these new locations]],
		[[Added Vehicle Doors and Windows individual control to the Scan tab Target actions]],
		[[Added new Weapon to Companion Equipment: Neon Red Mantis Blades]],
		[[Added new Despawn All button to Decor tab]],
		[[Enabled AI Driver on the Player's Delamain car]],
		[[Fixed issue where Mantis Blades would not work when picked in the Equipment popup]],
		[[Fixed issue where non-localized text would spam logs]],
		[[Fixed issue where adding a Spawnable Favorite would wrongly appear in the Active Spawns]],
		[[Fixed issue where Spawned NPCs would not fight each other]],
		[[Fixed issue where filtering locations would be case-sensitive]],
	},
	{
		'2.6',
		'2023 Dec 24',
		...
		[[-- Thanks donk from CyberScript for your hard work!]],
